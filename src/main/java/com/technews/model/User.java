...
@Entity
@JsonIgnoerties({"hibernateLazyInitializer", "handler"})
@Table(name = "user")

public class User implements Serializable {
//    instance variable level annotations
    @Id//Id will be used as a unique identifier
    @GeneratedValue(strategy = GenerationType.AUTO)//denotes that it wilL be a generated value
//    instance variables
    private Integer id;
    private String username;
    @Column(unique = true)//must be unique and non duplicate
    private String email;
    private String password;
    @Transient //signal to SpringBootJpa to not persist this data
    boolean loggedIn;
